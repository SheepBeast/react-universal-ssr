...
class SideBar extends React.Component {
  render() {
    var { userInfo, sideBarRolesRefer } = this.props
    var { userPhoto, accountName } = userInfo

    var { statistics, propertyManage, deviceManage, userManage, msgManage } = sideBarRolesRefer
    ...
    return (
      <Sider id="SideBar" width={280} className="bg-w" style={{ borderRight: '1px solid #eee' }}>
        ...
        <Menu
          ...
          {
            statistics ? <MenuItem key="statistics">
              <Link to="/statistics">
          ...
          {
            propertyManage ? <MenuItem key="property">
              <Link to="/property">
          ...
          {
            deviceManage ? <SubMenu key="device" title={
              <span>
          ...
          {
            userManage ? <SubMenu key="user" title={
              <span>
          ...
          {
            msgManage ? <SubMenu key="news" title={
              <span>
...
const mapStateToProps = state => ({
  ...
  sideBarRolesRefer: state.sideBarRolesRefer || {}
})
