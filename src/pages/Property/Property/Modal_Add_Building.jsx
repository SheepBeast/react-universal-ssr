...
class Modal_Add_Building extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      visible: false,
  ...
  render() {
    ...
    return (
      <Modal title="添加楼栋" visible={this.state.visible} destroyOnClose={true} okText="下一步" cancelText="取消" onOk={this.onOk.bind(this)} onCancel={this.hide.bind(this)}>
...
export default connect(null, mapDispatchToProps)(Form.create()(Modal_Add_Building))