...
import './index.less'
import { editUserData, fetchUserDetailData } from '../../actions/user';
...
const mapDispatchToProps = dispatch => ({
  editUser: params => dispatch(editUserData(params)),
  fetchUserDetail: params => dispatch(fetchUserDetailData(params)),
