        ...
        <Row gutter={20}>
          <Col span={13} style={{ border: '1px dashed #eee', height: 340 }}>
            <div className="pos-center">
              <div className="tc">
                <Upload action={__UPLOAD_URL__} onChange={this.onUploadChange.bind(this)} beforeUpload={this.onUploadBeforeUpload.bind(this)} showUploadList={false} multiple={false} name="avatar" accept="image/*">
